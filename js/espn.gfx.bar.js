				...
				.each(function(d, i) {
					...
					if (showMarker && i === 1) {
						parent.append('path')
							...
							// the default triangle / marker generated by d3.js symbol is scaled down to suit our design, hence 0.7 (which is now moved to the config)
							.attr('transform', 'translate(' + (chart.width() - chart.width() * d.percent / 100) + ',' + (barPosY + 4) + '),scale(' + chart.config.markerScale + ',' + chart.config.markerScale + ')');
					}
				});
		}
